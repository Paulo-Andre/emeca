    ...
    if request.method == 'POST':
        try:
            ...
            nova_matricula = matricula(
                ...
                racaCorDoAluno=dados.get('racaCorDoAluno', '').strip().upper(),
                ...
                laudoAluno=dados.get('possuiLaudoAluno', '').strip().upper(),
                recebeBeneficioAluno=dados.get('recebeBeneficioAluno').strip().upper(),
                alergiaAluno=dados.get('alergiaAluno', '').strip().upper(),
                temIrmaosEscola=dados.get('temIrmaosEscola', '').strip().upper(),
                ...
                # ================= RESPONSÁVEL =================
                tipoResponsavel=dados.get('tipoResponsavel', '').strip().upper(),
                ...
                cep=dados.get('cep'),
                situacaoCasa=dados.get('situacaoCasa', '').strip().upper(),
                estadoCivilPais=dados.get('estadoCivilPais', '').strip().upper(),
